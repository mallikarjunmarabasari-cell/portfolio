    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        <motion.div
          ...
          style={{ borderColor: "#D9770620", backgroundColor: "#D977060a" }}
        >
          <AlertCircle size={14} className="shrink-0 mt-0.5" style={{ color: "#D97706" }} />
          <p className="text-xs text-muted-foreground leading-relaxed">
            <span className="font-medium text-foreground">Backend not wired yet</span> — submissions
            are mocked. Use the direct links above to reach me.
          </p>
        </motion.div>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <motion.button
                ...
                className="flex items-center justify-center gap-2 w-full py-3.5 rounded-full font-semibold text-sm transition-all duration-200"
